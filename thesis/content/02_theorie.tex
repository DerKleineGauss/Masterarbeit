...
\begin{align}
  \expval{A} &= \sum_l \sum_k  w_k \bra{k}A\ket{l}\bra{l}\ket{k} \\
   &= \sum_l \bra{l}\hat{\rho} A\ket{l} = \text{Sp}(\hat{\rho} A)
   \label{eq:expval}
\end{align}
mit
\begin{equation}
...
Es lässt sich ferner die Dichtematrix ${\rho : H^* \times H \times \mathbb{R} \rightarrow \mathbb{C}}$ definieren als Darstellung des Dichteoperators in der Ortsbasis $\{\ket{x}\}$. Für ein einzelnes Teilchen beispielsweise ist letztere die Menge der Eigenvektoren des Orstoperators
\begin{equation*}
