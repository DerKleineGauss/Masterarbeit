...
\end{align*}
In dieser Form lässt sich die Definition der Stromdichte (Gleichung \eqref{eq:expval_j}) motivieren. Für $\tilde{y}=0$ ist mit $V=V^*$ der Driftterm $\tilde{B}(\tilde{x},0,t)$ gleich Null. Dann verbleibt mit der Definition der Teilchendichte aus Gleichung \eqref{eq:expval_n} die \emph{Kontinuitätsgleichung}\index{Kontinuitätsgleichung}
\begin{equation}
