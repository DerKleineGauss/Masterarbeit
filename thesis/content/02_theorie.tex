...
Eine mögliche Wahl für Randbedingungen bezüglich der Relativkoordinate für die LvNG sind Dirichlet-Randbedingungen:
\begin{equation}
  \begin{aligned}
...
\begin{figure}
  ...
  \label{fig:pot1}
\end{figure}
Die Lösungen ergeben sich dabei aus einer Linearkombination von generischen vorwärts- und rückwärts-Streuzuständen, resultierend aus der Zeitumkehrbarkeit.
