...
% \begin{figure}
%   \centering
%   \includegraphics[width=0.8\textwidth]{plots/IV/IV_qtbm_dg_grob.eps}
%   \caption{Strom-Spannungs-Kennlinien im Vergleich. Parameter der Numerik: $K_x=30$, $N=7$, $K_y=280$. Zusätzlich gezeigt ist das Ergebnis einer \ac{qtbm}-Rechnung.}
%   \label{fig:iv1}
% \end{figure}
...
\todo{Lukas fragen, worauf ich mich mit QTBM referenzieren kann.}
